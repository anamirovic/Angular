...
//export const placeOrder = createAction('Place Order', props<{ bookId: number; userId: number }>());
export const placeOrder = createAction('Place Order',props<{ bookIds: string; userId: number }>());
